...
[ $(git tag --points-at HEAD | grep java-base | wc -l) == 1 ] || (
  ...
  options=("Package release" "Minor release" "Major release" "Release with a custom version")
...
# Notify Microbadger
curl -XPOST https://hooks.microbadger.com/images/hbpmip/java-base/Kn0kA37XGbM3oPUcG0oiVox7b3Y=
