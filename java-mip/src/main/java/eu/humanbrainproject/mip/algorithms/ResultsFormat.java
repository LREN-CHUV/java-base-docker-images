...
/**
 * As the algorithm results are exported as a generic text, we define here what was the format used
...
public enum ResultsFormat {
   ...
   */
  TABULAR_DATA_RESOURCE_JSON(
      "tabular_data_resource_json", "application/vnd.tabular-data-resource+json"),
