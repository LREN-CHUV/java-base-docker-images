...
public class ClusModelPFASerializer<M extends ClusModel> extends AlgorithmSerializer<ClusAlgorithm<M>> {
	...
	@Override
	protected void writeModelConstants(ClusAlgorithm<M> value, JsonGenerator jgen) throws IOException {
	...
	@Override
	protected void writePfaFunctionDefinitions(ClusAlgorithm<M> value, JsonGenerator jgen) throws IOException {
		M model = value.getModel();
